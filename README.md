Repository for the paper **While My RecSys Gently Weeps: Energy-Efficent Early Stopping with Exponential Moving Average for Green Recommender Systems**, submitted at ACM Transactions on Information Systems (TOIS).
